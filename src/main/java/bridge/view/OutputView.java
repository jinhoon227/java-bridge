...
public class OutputView {
    ...
    public void printMap(MoveRecord moveRecord) {
        ...
        String upMap = mapMaker.makeMap(moveRecord, MovementCommand.UP);
        String downMap = mapMaker.makeMap(moveRecord, MovementCommand.DOWN);
    ...
    public void printResult(Player player) {
        ...
        printMap(player.getMoveRecord());

        System.out.println("게임 성공 여부: " + moveResult(player.isPlayerMove()));
